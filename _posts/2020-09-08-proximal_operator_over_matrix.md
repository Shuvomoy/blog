...
$$
\begin{align*}
\mathcal{C} := & \Big\{ X\in\mathbf{S}^{n}\mid\sum_{j=1}^{n}A_{j}X_{ij}=bX_{ii},\qquad i\in1,\ldots,n,\\
 & \hfill\qquad\qquad\sum_{j=1}^{n}A_{j}X_{jj}=b,\\
 & \hfill\qquad\qquad 0\leq X_{ij}\leq X_{ii},\qquad i,j=1,\ldots,n,i\neq j,\\
 & \hfill\qquad \qquad0\leq X_{ij}\leq1,\qquad i,j=1,\ldots,n\\
 & \hfill\qquad \qquad X_{ii}+X_{jj}-X_{ij}\leq1,\qquad i,j=1,\ldots,n,i\neq j,\\
 & \hfill\qquad \qquad X\succeq0\Big\}.
\end{align*}
$$
