# In this blog we will discuss ways of writing data into a file in Julia. We will discuss two methods of doing it: using `JLD2` package and writing directly into a `.jl` file.
...
# The literate code for this blog is available at: [this link](https://raw.githubusercontent.com/Shuvomoy/blog/gh-pages/codes/saving_data_files_csv.jl).
